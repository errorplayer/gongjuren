...
export const TOOL_CATEGORIES = {
  ...
  tools: [
    ...
    {
      id: 'mdnote',
      title: 'Markdown/txt速记',
      desc: '支持公式、mermaid渲染、高清PDF导出',
      brochure: '丰富的渲染支持，公式、图片、代码、表格、mermaid语言完美渲染，还能高清PDF导出，你的浏览器就是优雅的Markdown/txt笔记本，安全隐私放心~',
      icon: '📝',
      tags: ['HOT'],        // 可选
      category: 'dev-helper', // 对应 subCategories 里的某个 id
      path: 'https://md.520tool.cc',  // ✅ 直接写外链即可
      usageCount: 12,
