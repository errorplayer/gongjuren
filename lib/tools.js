export const TOOLS = [
  { id: 'moments-grid', icon: '🖼️', title: '朋友圈9宫格裁剪', desc: '上传图片,一键生成9张朋友圈素材,支持拖拽调整' },
  { id: 'sound-therapy', icon: '📻', title: '声音疗愈', desc: '助眠、放松、专注、心流状态' , badge: ['Hot']},
  { id: 'random-chat', icon: '⚧️', title: '随机聊天室', desc: '上班累了吧？来这里遇见陌生的Ta ~' },
  { id: 'career', icon: '💼', title: '职场工具箱', desc: 'AI驱动的求职能力诊断与优化平台', badge: ['AI'] },
